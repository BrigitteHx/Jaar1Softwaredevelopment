...
def calculate():
    ...
    aviLabel.config(text= f"avi Score: {getAVIScore(textToBeCalculated)}")
...
aviLabel = tk.Label(root, text=f'avi score:', width=20, bg='black', fg='white')
